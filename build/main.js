...
var require_tracing = __commonJS((exports, module) => {
  var scheduler_tracing_development = __toESM(require_scheduler_tracing_development(), 1);
  if (false) {
  } else {
    module.exports = scheduler_tracing_development;
  }
});
...
var require_react_dom_development = __commonJS((exports) => {
  ...
  var tracing = __toESM(require_tracing(), 1);
  if (true) {
    (function() {
      var _assign = require_object_assign();
      var checkPropTypes = require_checkPropTypes();
      ...
      var Layout = 2;
      var Passive$1 = 4;
      var { ReactCurrentDispatcher, ReactCurrentBatchConfig: ReactCurrentBatchConfig$1 } = ReactSharedInternals;
      ...
      function updateSuspenseListComponent(current2, workInProgress2, renderExpirationTime2) {
        ...
        if ((workInProgress2.mode & BlockingMode) === NoMode) {
          ...
          switch (revealOrder) {
            ...
            case "together": {
              initSuspenseListRenderState(workInProgress2, false, null, null, undefined, workInProgress2.lastEffect);
              break;
            }
            default: {
              workInProgress2.memoizedState = null;
      ...
      function completeWork(current2, workInProgress2, renderExpirationTime2) {
        ...
        switch (workInProgress2.tag) {
          ...
          case SuspenseComponent: {
            ...
            if (current2 === null) {
              if (workInProgress2.memoizedProps.fallback !== undefined) {
      ...
      function logCapturedError(capturedError) {
        ...
        {
          var { componentName, componentStack, errorBoundaryName, errorBoundaryFound, willRetry } = capturedError;
      ...
      var ceil = Math.ceil;
      var { ReactCurrentDispatcher: ReactCurrentDispatcher$1, ReactCurrentOwner: ReactCurrentOwner$2, IsSomeRendererActing } = ReactSharedInternals;
      var NoContext = 0;
          ...
          onCommitFiberRoot = function(root2, expirationTime) {
            try {
              ...
              if (enableProfilerTimer) {
                ...
                hook.onCommitFiberRoot(rendererID, root2, undefined, didError);
              }
            } catch (err) {
              if (true) {
                if (!hasLoggedError) {
...
var require_toPrimitive = __commonJS((exports, module) => {
  var _toPrimitive2 = function(input, hint) {
...
var require_toPropertyKey = __commonJS((exports, module) => {
  var _toPropertyKey2 = function(arg) {
...
var require_objectSpread2 = __commonJS((exports, module) => {
  ...
  var _objectSpread22 = function(e) {
...
var require_redux = __commonJS((exports) => {
  ...
  var isPlainObject4 = function(obj) {
  ...
  var createStore2 = function(reducer, preloadedState, enhancer) {
    var _ref2;
    ...
    if (typeof enhancer !== "undefined") {
      if (typeof enhancer !== "function") {
        throw new Error("Expected the enhancer to be a function. Instead, received: '" + kindOf2(enhancer) + "'");
      }
      return enhancer(createStore2)(reducer, preloadedState);
    }
    if (typeof reducer !== "function") {
      throw new Error("Expected the root reducer to be a function. Instead, received: '" + kindOf2(reducer) + "'");
    }
    ...
    function subscribe(listener) {
      if (typeof listener !== "function") {
        throw new Error("Expected the listener to be a function. Instead, received: '" + kindOf2(listener) + "'");
      }
      if (isDispatching) {
    ...
    function replaceReducer(nextReducer) {
      if (typeof nextReducer !== "function") {
        throw new Error("Expected the nextReducer to be a function. Instead, received: '" + kindOf2(nextReducer));
      }
      ...
      return _ref = {
        subscribe: function subscribe(observer) {
          if (typeof observer !== "object" || observer === null) {
            throw new Error("Expected the observer to be an object. Instead, received: '" + kindOf2(observer) + "'");
          }
  ...
  var getUnexpectedStateShapeWarningMessage2 = function(inputState, reducers, action, unexpectedKeyCache) {
  ...
  var assertReducerShape2 = function(reducers) {
  ...
  var combineReducers2 = function(reducers) {
    var reducerKeys = Object.keys(reducers);
    var finalReducers = {};
    ...
    try {
      assertReducerShape2(finalReducers);
    } catch (e) {
    ...
    return function combination(state, action) {
      ...
      if (true) {
        var warningMessage = getUnexpectedStateShapeWarningMessage2(state, finalReducers, action, unexpectedKeyCache);
        if (warningMessage) {
  ...
  var bindActionCreators3 = function(actionCreators, dispatch) {
    if (typeof actionCreators === "function") {
      return bindActionCreator(actionCreators, dispatch);
    }
    if (typeof actionCreators !== "object" || actionCreators === null) {
      throw new Error("bindActionCreators expected an object or a function, but instead received: '" + kindOf2(actionCreators) + "'. Did you write \"import ActionCreators from\" instead of \"import * as ActionCreators from\"?");
    }
  ...
  var applyMiddleware = function() {
    ...
    return function(createStore3) {
      return function() {
        var store = createStore3.apply(undefined, arguments);
  ...
  var randomString3 = function randomString() {
  ...
  if (typeof isCrushed2.name === "string" && isCrushed2.name !== "isCrushed") {
  ...
  exports.__DO_NOT_USE__ActionTypes = ActionTypes2;
  exports.applyMiddleware = applyMiddleware;
  exports.bindActionCreators = bindActionCreators3;
...
var Provider = function(_ref) {
  var { store, context, children } = _ref;
  var contextValue = import_react3.useMemo(function() {
  ...
  var previousState = import_react3.useMemo(function() {
...
function useReduxContext() {
  var contextValue = import_react5.useContext(ReactReduxContext);
  if (!contextValue) {
...
function createStoreHook(context) {
  ...
  var useReduxContext3 = context === ReactReduxContext ? useReduxContext : function() {
    return import_react6.useContext(context);
  };
  return function useStore() {
    var _useReduxContext = useReduxContext3(), store = _useReduxContext.store;
    return store;
  };
}
...
var useSelectorWithStoreAndSubscription = function(selector, equalityFn, store, contextSub) {
  var _useReducer = import_react7.useReducer(function(s) {
    return s + 1;
  }, 0), forceRender = _useReducer[1];
  var subscription = import_react7.useMemo(function() {
    return new Subscription(store, contextSub);
  }, [store, contextSub]);
  var latestSubscriptionCallbackError = import_react7.useRef();
  var latestSelector = import_react7.useRef();
  var latestStoreState = import_react7.useRef();
  var latestSelectedState = import_react7.useRef();
...
function createSelectorHook(context) {
  ...
  var useReduxContext4 = context === ReactReduxContext ? useReduxContext : function() {
    return import_react7.useContext(context);
  };
  return function useSelector(selector, equalityFn) {
    ...
    var _useReduxContext = useReduxContext4(), store = _useReduxContext.store, contextSub = _useReduxContext.subscription;
    var selectedState = useSelectorWithStoreAndSubscription(selector, equalityFn, store, contextSub);
    import_react7.useDebugValue(selectedState);
    return selectedState;
  };
}
...
var combineReducers = function(reducers) {
  ...
  for (var i = 0;i < reducerKeys.length; i++) {
    ...
    if (true) {
      if (typeof reducers[key] === "undefined") {
        warning4("No reducer provided for key \"" + key + "\"");
      }
    }
    if (typeof reducers[key] === "function") {
      finalReducers[key] = reducers[key];
...
if (typeof isCrushed.name === "string" && isCrushed.name !== "isCrushed") {
  warning4('You are currently using minified code outside of NODE_ENV === "production". This means that you are running a slower development build of Redux. You can use loose-envify (https://github.com/zertosh/loose-envify) for browserify or setting mode to production in webpack (https://webpack.js.org/concepts/mode/) to ensure you have the correct code for your production build.');
}
...
var P = function(r2, e) {
  ...
  return e.h.O || b("ES5").S(e, r2, o2), o2 ? (i2[Q].P && (g(e), n(4)), t(r2) && (r2 = M(e, r2), e.l || x(e, r2)), e.u && b("Patches").M(i2[Q], r2, e.u, e.s)) : r2 = M(e, i2, []), g(e), e.u && e.v(e.u, e.s), r2 !== H ? r2 : undefined;
};
var M = function(n2, r2, t2) {
  if (y(r2))
    return r2;
  var e = r2[Q];
  if (!e)
...
var A = function(e, i2, o2, a2, c2, s2) {
  if (c2 === o2 && n(5), r(c2)) {
  ...
  function e(r2) {
    ...
    this.O = B, this.F = true, this.produce = function(r3, i3, o2) {
      ...
      if (!r3 || typeof r3 != "object") {
        if ((f2 = i3(r3)) === H)
          return;
        return f2 === undefined && (f2 = r3), e2.F && d(f2, true), f2;
      }
      n(21, r3);
...
// src/lib/minesweeper.js
var initBoard = (width, height, mineCount) => {
  const candidates = Array(width * height).fill().map((v2, i2) => i2);
  const shuffle = [];
  const boardData = [];
  ...
  for (let i2 = 0;i2 < shuffle.length; i2++) {
    const x2 = shuffle[i2] % width;
    const y2 = Math.floor(shuffle[i2] / width);
    boardData[y2][x2] = CODES.MINE;
  }
  return boardData;
};
var getNextCellCode = (code) => {
  switch (code) {
    case CODES.NOTHING:
      return CODES.FLAG;
    case CODES.MINE:
...
var expandOpenedCell = (boardData, x2, y2) => {
  let openedCellCount = 0;
  const getMineCount = (x3, y3) => {
    let aroundCode = [];
    let mineCount = 0;
    aroundCode = boardData[y3 - 1] ? aroundCode.concat(boardData[y3 - 1][x3 - 1], boardData[y3 - 1][x3], boardData[y3 - 1][x3 + 1]) : aroundCode;
    aroundCode = aroundCode.concat(boardData[y3][x3 - 1], boardData[y3][x3 + 1]);
    aroundCode = boardData[y3 + 1] ? aroundCode.concat(boardData[y3 + 1][x3 - 1], boardData[y3 + 1][x3], boardData[y3 + 1][x3 + 1]) : aroundCode;
    mineCount = aroundCode.filter((v2) => [
      CODES.MINE,
      CODES.MINE_FLAG,
      CODES.MINE_QUESTION
    ].includes(v2)).length;
  ...
  const dfsSearch = (x3, y3) => {
    if (boardData[y3][x3] !== CODES.NOTHING) {
      return;
    }
    boardData[y3][x3] = getMineCount(x3, y3);
    openedCellCount++;
    let aroundPoint = [];
    aroundPoint = boardData[y3 - 1] ? aroundPoint.concat({ x: x3 - 1, y: y3 - 1 }, { x: x3, y: y3 - 1 }, { x: x3 + 1, y: y3 - 1 }) : aroundPoint;
    aroundPoint = aroundPoint.concat({ x: x3 - 1, y: y3 }, { x: x3 + 1, y: y3 });
    aroundPoint = boardData[y3 + 1] ? aroundPoint.concat({ x: x3 - 1, y: y3 + 1 }, { x: x3, y: y3 + 1 }, { x: x3 + 1, y: y3 + 1 }) : aroundPoint;
    if (boardData[y3][x3] === 0) {
      aroundPoint.forEach((v2) => {
        dfsSearch(v2.x, v2.y);
      });
    }
  };
...
var SHOW_SETTINGS = "control/SHOW_SETTINGS";
var HIDE_SETTINGS = "control/HIDE_SETTINGS";
var SET_GAME = "control/SET_GAME";
var RESTART_GAME = "control/RESTART_GAME";
var UPDATE_ELAPSED_TIME = "control/UPDATE_ELAPSED_TIME";
var OPEN_CELL = "control/OPEN_CELL";
var ROTATE_CELL_STATE = "control/ROTATE_CELL_STATE";
var showSettings = () => ({ type: SHOW_SETTINGS });
var hideSettings = () => ({ type: HIDE_SETTINGS });
var setGame = (width, height, mineCount) => ({ type: SET_GAME, width, height, mineCount });
var restartGame = () => ({ type: RESTART_GAME });
var updateElapsedTime = () => ({ type: UPDATE_ELAPSED_TIME });
var openCell = (x2, y2) => ({ type: OPEN_CELL, x: x2, y: y2 });
var rotateCellState = (x2, y2) => ({ type: ROTATE_CELL_STATE, x: x2, y: y2 });
var initialState = {
...
function control_default(state = initialState, action) {
  switch (action.type) {
    case SHOW_SETTINGS:
...
// src/store/index.js
var DEBUG = true;
var store_default = createStore(rootReducer, DEBUG && $composeWithDevTools());
...
var stylis_min = function(W2) {
  function M2(d2, c2, e, h2, a2) {
    for (var m = 0, b2 = 0, v2 = 0, n2 = 0, q2, g2, x2 = 0, K = 0, k2, u2 = k2 = q2 = 0, l2 = 0, r2 = 0, I2 = 0, t2 = 0, B3 = e.length, J = B3 - 1, y2, f2 = "", p2 = "", F3 = "", G3 = "", C;l2 < B3; ) {
      g2 = e.charCodeAt(l2);
      l2 === J && b2 + n2 + v2 + m !== 0 && (b2 !== 0 && (g2 = b2 === 47 ? 10 : 47), n2 = v2 = m = 0, B3++, J++);
      if (b2 + n2 + v2 + m === 0) {
        ...
        switch (g2) {
          case 123:
                      ...
                      a: {
                        for (u2 = l2 + 1;u2 < J; ++u2) {
                          switch (e.charCodeAt(u2)) {
                            case 47:
                              if (g2 === 42 && e.charCodeAt(u2 - 1) === 42 && l2 + 2 !== u2) {
                                l2 = u2 + 1;
                                break a;
                              }
                              break;
            ...
            switch (q2) {
              case 64:
                ...
                t2 = k2.length;
                0 < A2 && (r2 = X2(O2, f2, I2), C = H2(3, k2, r2, c2, D2, z2, t2, g2, a2, h2), f2 = r2.join(""), C !== undefined && (t2 = (k2 = C.trim()).length) === 0 && (g2 = 0, k2 = ""));
                if (0 < t2)
                  switch (g2) {
                    case 115:
                      f2 = f2.replace(da, ea);
          ...
          case 59:
            ...
            if (1 < (t2 = f2.length))
              switch (u2 === 0 && (q2 = f2.charCodeAt(0), q2 === 45 || 96 < q2 && 123 > q2) && (t2 = (f2 = f2.replace(" ", ":")).length), 0 < A2 && (C = H2(1, f2, c2, d2, D2, z2, p2.length, h2, a2, h2)) !== undefined && (t2 = (f2 = C.trim()).length) === 0 && (f2 = "\0\0"), q2 = f2.charCodeAt(0), g2 = f2.charCodeAt(1), q2) {
                case 0:
                  break;
                case 64:
                  if (g2 === 105 || g2 === 99) {
              ...
              if (!(0 < n2 + m + v2))
                switch (b2) {
                  case 0:
                    ...
                    break;
                  case 42:
                    g2 === 47 && x2 === 42 && t2 + 2 !== l2 && (e.charCodeAt(t2 + 2) === 33 && (p2 += e.substring(t2, l2 + 1)), y2 = "", b2 = 0);
                }
          }
          b2 === 0 && (f2 += y2);
      }
    ...
    if (0 < t2) {
      r2 = c2;
      if (0 < A2 && (C = H2(2, p2, r2, d2, D2, z2, t2, h2, a2, h2), C !== undefined && (p2 = C).length === 0))
        return G3 + p2 + F3;
      p2 = r2.join(",") + "{" + p2 + "}";
      if (w2 * E2 !== 0) {
        w2 !== 2 || L2(p2, 2) || (E2 = 0);
  ...
  function P2(d2, c2, e, h2) {
    ...
    switch (m) {
      ...
      case 953:
        if (la.test(d2) === true)
          return (b2 = d2.substring(d2.indexOf(":") + 1)).charCodeAt(0) === 115 ? P2(d2.replace("stretch", "fill-available"), c2, e, h2).replace(":fill-available", ":stretch") : a2.replace(b2, "-webkit-" + b2) + a2.replace(b2, "-moz-" + b2.replace("fill-", "")) + a2;
        break;
      case 962:
        if (a2 = "-webkit-" + a2 + (a2.charCodeAt(5) === 102 ? "-ms-" + a2 : "") + a2, e + h2 === 211 && a2.charCodeAt(13) === 105 && 0 < a2.indexOf("transform", 10))
          return a2.substring(0, a2.indexOf(";", 27) + 1).replace(ma, "$1-webkit-$2") + a2;
    }
    return a2;
  }
  function L2(d2, c2) {
    var e = d2.indexOf(c2 === 1 ? ":" : "{"), h2 = d2.substring(0, c2 !== 3 ? e : 10);
    e = d2.substring(e + 1, d2.length - 1);
    return R2(c2 !== 2 ? h2 : h2.replace(na, "$1"), e, c2);
  }
  function ea(d2, c2) {
    var e = P2(c2, c2.charCodeAt(0), c2.charCodeAt(1), c2.charCodeAt(2));
    return e !== c2 + ";" ? e.replace(oa, " or ($1)").substring(4) : "(" + c2 + ")";
  }
  function H2(d2, c2, e, h2, a2, m, b2, v2, n2, q2) {
    for (var g2 = 0, x2 = c2, w3;g2 < A2; ++g2) {
      switch (w3 = S2[g2].call(B2, d2, x2, e, h2, a2, m, b2, v2, n2, q2)) {
        case undefined:
        case false:
        case true:
        case null:
    ...
    switch (d2) {
      ...
      default:
        if (typeof d2 === "function")
          ...
          for (var c2 = 0, e = d2.length;c2 < e; ++c2) {
            T(d2[c2]);
          }
        else
          Y2 = !!d2 | 0;
  ...
  function U2(d2) {
    d2 = d2.prefix;
    d2 !== undefined && (R2 = null, d2 ? typeof d2 !== "function" ? w2 = 1 : (w2 = 2, R2 = d2) : w2 = 0);
    return U2;
  }
  function B2(d2, c2) {
    var e = d2;
    ...
    if (0 < A2) {
      ...
      h2 !== undefined && typeof h2 === "string" && (c2 = h2);
    }
    var a2 = M2(O2, e, c2, 0, 0);
    0 < A2 && (h2 = H2(-2, a2, e, e, D2, z2, a2.length, 0, 0, 0), h2 !== undefined && (a2 = h2));
    V2 = "";
    E2 = 0;
    z2 = D2 = 1;
    return a2;
...
var v2 = function() {
  return (v2 = Object.assign || function(e2) {
...
var D2 = function() {
  for (var e2 = arguments.length <= 0 ? undefined : arguments[0], t3 = [], n3 = 1, r3 = arguments.length;n3 < r3; n3 += 1)
    t3.push(n3 < 0 || arguments.length <= n3 ? undefined : arguments[n3]);
...
var j2 = function(e2) {
  ...
  throw new Error(D2.apply(undefined, [R2[e2]].concat(n3)).trim());
};
var ee = function(e2) {
  var t3, n3 = "";
  for (t3 = Math.abs(e2);t3 > 52; t3 = t3 / 52 | 0)
    n3 = Q2(t3 % 52) + n3;
  return (Q2(t3 % 52) + n3).replace(K, "$1-$2");
};
var re = function(e2) {
...
var ce = function(e2) {
  var t3, n3, r3, o3, i3 = e2 === undefined ? E2 : e2, s3 = i3.options, a3 = s3 === undefined ? E2 : s3, c3 = i3.plugins, u3 = c3 === undefined ? w2 : c3, l3 = new stylis_browser_esm_default(a3), d3 = [], h3 = function(e3) {
    function t4(t5) {
      if (t5)
        try {
          e3(t5 + "}");
    ...
    return function(n4, r4, o4, i4, s4, a4, c4, u4, l4, d4) {
      switch (n4) {
        case 1:
    ...
    d3.push(e3);
  }), f2 = function(e3, r4, i4) {
    return r4 === 0 && ae.indexOf(i4[n3.length]) !== -1 || i4.match(o3) ? e3 : "." + t3;
  };
  function m(e3, i4, s4, a4) {
    a4 === undefined && (a4 = "&");
    var c4 = e3.replace(se, ""), u4 = i4 && s4 ? s4 + " " + i4 + " { " + c4 + " }" : c4;
    return t3 = a4, n3 = i4, r3 = new RegExp("\\" + n3 + "\\b", "g"), o3 = new RegExp("(\\" + n3 + "\\b){2,}"), l3(s4 || !i4 ? "" : i4, u4);
  }
  return l3.use([].concat(u3, [function(e3, t4, o4) {
    e3 === 2 && o4.length && o4[0].lastIndexOf(n3) > 0 && (o4[0] = o4[0].replace(r3, f2));
  }, h3, function(e3) {
    if (e3 === -2) {
      var t4 = d3;
      return d3 = [], t4;
    }
  }])), m.hash = u3.length ? u3.reduce(function(e3, t4) {
    return t4.name || j2(15), te(e3, t4.name);
  }, 5381).toString() : "", m;
};
var fe = function() {
  return import_react8.useContext(ue) || he;
};
var me = function() {
  return import_react8.useContext(de) || pe;
};
var ye = function(e2) {
  var t3 = import_react8.useState(e2.stylisPlugins), n3 = t3[0], i3 = t3[1], c3 = fe(), u3 = import_react8.useMemo(function() {
    var t4 = c3;
  ...
  }, [e2.disableCSSOMInjection, e2.sheet, e2.target]), l3 = import_react8.useMemo(function() {
    return ce({ options: { prefix: !e2.disableVendorPrefixes }, plugins: n3 });
  }, [e2.disableVendorPrefixes, n3]);
  return import_react8.useEffect(function() {
    import_shallowequal.default(n3, e2.stylisPlugins) || i3(e2.stylisPlugins);
  }, [e2.stylisPlugins]), import_react8.default.createElement(ue.Provider, { value: u3 }, import_react8.default.createElement(de.Provider, { value: l3 }, import_react8.default.Children.only(e2.children)));
};
var be = function(e2) {
  return ge.test(e2) ? e2.replace(Se, Ee).replace(we, "-ms-") : e2;
};
var Ne = function(e2, n3, r3, o3) {
  if (Array.isArray(e2)) {
    for (var i3, s3 = [], a3 = 0, c3 = e2.length;a3 < c3; a3 += 1)
      (i3 = Ne(e2[a3], n3, r3, o3)) !== "" && (Array.isArray(i3) ? s3.push.apply(s3, i3) : s3.push(i3));
    return s3;
  }
  if (_e(e2))
    return "";
  ...
  if (b2(e2)) {
    if (typeof (l3 = e2) != "function" || l3.prototype && l3.prototype.isReactComponent || !n3)
      return e2;
    var u3 = e2(n3);
    return import_react_is2.isElement(u3) && console.warn(_2(e2) + " is not a styled component and cannot be referred to via component selector. See https://www.styled-components.com/docs/advanced#referring-to-other-components for more details."), Ne(u3, n3, r3, o3);
  }
  var l3;
  return e2 instanceof ve ? r3 ? (e2.inject(r3, o3), e2.getName(o3)) : e2 : S2(e2) ? function e(t3, n4) {
    var r4, o4, i4 = [];
    for (var s4 in t3)
      t3.hasOwnProperty(s4) && !_e(t3[s4]) && (S2(t3[s4]) ? i4.push.apply(i4, e(t3[s4], s4)) : b2(t3[s4]) ? i4.push(be(s4) + ":", t3[s4], ";") : i4.push(be(s4) + ": " + (r4 = s4, (o4 = t3[s4]) == null || typeof o4 == "boolean" || o4 === "" ? "" : typeof o4 != "number" || o4 === 0 || (r4 in unitless_browser_esm_default) ? String(o4).trim() : o4 + "px") + ";"));
    return n4 ? [n4 + " {"].concat(i4, ["}"]) : i4;
  }(e2) : e2.toString();
};
var Ae = function(e2) {
  for (var t3 = arguments.length, n3 = new Array(t3 > 1 ? t3 - 1 : 0), r3 = 1;r3 < t3; r3++)
    n3[r3 - 1] = arguments[r3];
  return b2(e2) || S2(e2) ? Ne(g2(w2, [e2].concat(n3))) : n3.length === 0 && e2.length === 1 && typeof e2[0] == "string" ? e2 : Ne(g2(e2, n3));
};
var je = function(e2) {
...
var Be = function(e2, t3, n3) {
  var r3 = e2[n3];
  xe(t3) && xe(r3) ? Me(r3, t3) : e2[n3] = t3;
};
var Me = function(e2) {
  for (var t3 = arguments.length, n3 = new Array(t3 > 1 ? t3 - 1 : 0), r3 = 1;r3 < t3; r3++)
    n3[r3 - 1] = arguments[r3];
  for (var o3 = 0, i3 = n3;o3 < i3.length; o3++) {
    ...
    if (xe(s3))
      for (var a3 in s3)
        Ve(a3) && Be(e2, s3[a3], a3);
  }
  return e2;
};
var Ye = function(e2, t3, n3) {
  var o3 = N(e2), s3 = !ke(e2), a3 = t3.attrs, c3 = a3 === undefined ? w2 : a3, d3 = t3.componentId, h3 = d3 === undefined ? function(e3, t4) {
    var n4 = typeof e3 != "string" ? "sc" : je(e3);
    Fe[n4] = (Fe[n4] || 0) + 1;
    var r3 = n4 + "-" + Te("5.3.0" + n4 + Fe[n4]);
    return t4 ? t4 + "-" + r3 : r3;
  }(t3.displayName, t3.parentComponentId) : d3, p2 = t3.displayName, f2 = p2 === undefined ? function(e3) {
    return ke(e3) ? "styled." + e3 : "Styled(" + _2(e3) + ")";
  }(e2) : p2, g2 = t3.displayName && t3.componentId ? je(t3.displayName) + "-" + t3.componentId : t3.componentId || h3, S2 = o3 && e2.attrs ? Array.prototype.concat(e2.attrs, c3).filter(Boolean) : c3, A2 = t3.shouldForwardProp;
  o3 && e2.shouldForwardProp && (A2 = t3.shouldForwardProp ? function(n4, r3, o4) {
    return e2.shouldForwardProp(n4, r3, o4) && t3.shouldForwardProp(n4, r3, o4);
  } : e2.shouldForwardProp);
  var C, I2 = new ie(n3, g2, o3 ? e2.componentStyle : undefined), P2 = I2.isStatic && c3.length === 0, O2 = function(e3, t4) {
    return function(e4, t5, n4, r3) {
      var { attrs: o4, componentStyle: s4, defaultProps: a4, foldedComponentIds: c4, shouldForwardProp: d4, styledComponentId: h4, target: p3 } = e4;
      import_react8.useDebugValue(h4);
      var f3 = function(e5, t6, n5) {
        e5 === undefined && (e5 = E2);
        var r4 = v2({}, t6, { theme: e5 }), o5 = {};
        return n5.forEach(function(e6) {
          var t7, n6, i3, s5 = e6;
          for (t7 in b2(s5) && (s5 = s5(r4)), s5)
            r4[t7] = o5[t7] = t7 === "className" ? (n6 = o5[t7], i3 = s5[t7], n6 && i3 ? n6 + " " + i3 : n6 || i3) : s5[t7];
        }), [r4, o5];
      }(Oe(t5, import_react8.useContext(ze), a4) || E2, t5, o4), y3 = f3[0], g3 = f3[1], S3 = function(e5, t6, n5, r4) {
        var o5 = fe(), i3 = me(), s5 = t6 ? e5.generateAndInjectStyles(E2, o5, i3) : e5.generateAndInjectStyles(n5, o5, i3);
        return import_react8.useDebugValue(s5), !t6 && r4 && r4(s5), s5;
      }(s4, r3, y3, e4.warnTooManyClasses), w2 = n4, _3 = g3.$as || t5.$as || g3.as || t5.as || p3, N2 = ke(_3), A3 = g3 !== t5 ? v2({}, t5, {}, g3) : t5, C2 = {};
      for (var I3 in A3)
        I3[0] !== "$" && I3 !== "as" && (I3 === "forwardedAs" ? C2.as = A3[I3] : (d4 ? d4(I3, is_prop_valid_browser_esm_default, _3) : !N2 || is_prop_valid_browser_esm_default(I3)) && (C2[I3] = A3[I3]));
      return t5.style && g3.style !== t5.style && (C2.style = v2({}, t5.style, {}, g3.style)), C2.className = Array.prototype.concat(c4, h4, S3 !== h4 ? S3 : null, t5.className, g3.className).filter(Boolean).join(" "), C2.ref = w2, import_react8.createElement(_3, C2);
    }(C, e3, t4, P2);
  };
  return O2.displayName = f2, (C = import_react8.default.forwardRef(O2)).attrs = S2, C.componentStyle = I2, C.displayName = f2, C.shouldForwardProp = A2, C.foldedComponentIds = o3 ? Array.prototype.concat(e2.foldedComponentIds, e2.styledComponentId) : w2, C.styledComponentId = g2, C.target = o3 ? e2.target : e2, C.withComponent = function(e3) {
    var r3 = t3.componentId, o4 = function(e4, t4) {
      if (e4 == null)
        return {};
      var n4, r4, o5 = {}, i4 = Object.keys(e4);
      for (r4 = 0;r4 < i4.length; r4++)
        n4 = i4[r4], t4.indexOf(n4) >= 0 || (o5[n4] = e4[n4]);
      return o5;
    }(t3, ["componentId"]), i3 = r3 && r3 + "-" + (ke(e3) ? e3 : je(_2(e3)));
    return Ye(e3, v2({}, o4, { attrs: S2, componentId: i3 }), n3);
  }, Object.defineProperty(C, "defaultProps", { get: function() {
    return this._foldedDefaultProps;
  }, set: function(t4) {
    this._foldedDefaultProps = o3 ? Me({}, e2.defaultProps, t4) : t4;
  } }), Pe(f2, g2), C.warnTooManyClasses = function(e3, t4) {
    var n4 = {}, r3 = false;
    return function(o4) {
      if (!r3 && (n4[o4] = true, Object.keys(n4).length >= 200)) {
        var i3 = t4 ? ' with the id of "' + t4 + '"' : "";
        console.warn("Over 200 classes were generated for component " + e3 + i3 + ".\nConsider using the attrs method, together with a style object for frequently changed styles.\nExample:\n  const Component = styled.div.attrs(props => ({\n    style: {\n      background: props.background,\n    },\n  }))`width: 100%;`\n\n  <Component />"), r3 = true, n4 = {};
      }
    };
  }(f2, g2), C.toString = function() {
    return "." + C.styledComponentId;
  }, s3 && import_hoist_non_react_statics2.default(C, e2, { attrs: true, componentStyle: true, displayName: true, foldedComponentIds: true, shouldForwardProp: true, styledComponentId: true, target: true, withComponent: true }), C;
};
var g2 = function(e2, t3) {
  for (var n3 = [e2[0]], r3 = 0, o3 = t3.length;r3 < o3; r3 += 1)
    n3.push(t3[r3], e2[r3 + 1]);
  return n3;
};
var S2 = function(t3) {
  return t3 !== null && typeof t3 == "object" && (t3.toString ? t3.toString() : Object.prototype.toString.call(t3)) === "[object Object]" && !import_react_is2.typeOf(t3);
};
...
var T = function() {
  ...
  return t3.indexOfGroup = function(e3) {
    for (var t4 = 0, n3 = 0;n3 < e3; n3++)
      t4 += this.groupSizes[n3];
    return t4;
  }, t3.insertRules = function(e3, t4) {
    if (e3 >= this.groupSizes.length) {
      for (var n3 = this.groupSizes, r3 = n3.length, o3 = r3;e3 >= o3; )
        (o3 <<= 1) < 0 && j2(16, "" + e3);
      this.groupSizes = new Uint32Array(o3), this.groupSizes.set(n3), this.length = o3;
      for (var i3 = r3;i3 < o3; i3++)
        this.groupSizes[i3] = 0;
    }
    for (var s3 = this.indexOfGroup(e3 + 1), a3 = 0, c3 = t4.length;a3 < c3; a3++)
      this.tag.insertRule(s3, t4[a3]) && (this.groupSizes[e3]++, s3++);
  }, t3.clearGroup = function(e3) {
    if (e3 < this.length) {
      var t4 = this.groupSizes[e3], n3 = this.indexOfGroup(e3), r3 = n3 + t4;
    ...
    if (e3 >= this.length || this.groupSizes[e3] === 0)
      return t4;
    for (var n3 = this.groupSizes[e3], r3 = this.indexOfGroup(e3), o3 = r3 + n3, i3 = r3;i3 < o3; i3++)
      t4 += this.tag.getRule(i3) + "/*!sc*/\n";
    return t4;
  }, e2;
}();
var k2 = new Map;
...
var B2 = function(e2) {
  ...
  for (;x2.has(V2); )
    V2++;
  var t3 = V2++;
  return ((0 | t3) < 0 || t3 > 1 << 30) && j2(16, "" + t3), k2.set(e2, t3), x2.set(t3, e2), t3;
};
var M2 = function(e2) {
  return x2.get(e2);
};
var z2 = function(e2, t3) {
  k2.set(e2, t3), x2.set(t3, e2);
};
var L2 = "style[" + A2 + '][data-styled-version="5.3.0"]';
var G2 = new RegExp("^" + A2 + '\\.g(\\d+)\\[id="([\\w\\d-]+)"\\].*?"([^"]*)');
var F2 = function(e2, t3, n3) {
  for (var r3, o3 = n3.split(","), i3 = 0, s3 = o3.length;i3 < s3; i3++)
    (r3 = o3[i3]) && e2.registerName(t3, r3);
};
var Y2 = function(e2, t3) {
  for (var n3 = t3.innerHTML.split("/*!sc*/\n"), r3 = [], o3 = 0, i3 = n3.length;o3 < i3; o3++) {
    var s3 = n3[o3].trim();
    if (s3) {
      var a3 = s3.match(G2);
      if (a3) {
        var c3 = 0 | parseInt(a3[1], 10), u3 = a3[2];
        c3 !== 0 && (z2(u3, c3), F2(e2, u3, a3[3]), e2.getTag().insertRules(c3, r3)), r3.length = 0;
      } else
        r3.push(s3);
    }
  }
...
var q2 = function() {
  return typeof window != "undefined" && window.__webpack_nonce__ !== undefined ? window.__webpack_nonce__ : null;
};
var H2 = function(e2) {
  var t3 = document.head, n3 = e2 || t3, r3 = document.createElement("style"), o3 = function(e3) {
    for (var t4 = e3.childNodes, n4 = t4.length;n4 >= 0; n4--) {
      var r4 = t4[n4];
      if (r4 && r4.nodeType === 1 && r4.hasAttribute(A2))
        return r4;
    }
  }(n3), i3 = o3 !== undefined ? o3.nextSibling : null;
  r3.setAttribute(A2, "active"), r3.setAttribute("data-styled-version", "5.3.0");
  var s3 = q2();
  return s3 && r3.setAttribute("nonce", s3), n3.insertBefore(r3, i3), r3;
};
var $ = function() {
  function e2(e3) {
    var t4 = this.element = H2(e3);
  ...
  return t3.insertRule = function(e3, t4) {
    ...
    return t4 !== undefined && typeof t4.cssText == "string" ? t4.cssText : "";
  }, e2;
}();
var W2 = function() {
  function e2(e3) {
  ...
  return t3.insertRule = function(e3, t4) {
    if (e3 <= this.length && e3 >= 0) {
      var n3 = document.createTextNode(t4), r3 = this.nodes[e3];
...
var Z2 = function() {
  function e2(e3, t4, n3) {
    e3 === undefined && (e3 = E2), t4 === undefined && (t4 = {}), this.options = v2({}, X2, {}, e3), this.gs = t4, this.names = new Map(n3), !this.options.isServer && I2 && J && (J = false, function(e4) {
      for (var t5 = document.querySelectorAll(L2), n4 = 0, r3 = t5.length;n4 < r3; n4++) {
        var o3 = t5[n4];
        o3 && o3.getAttribute(A2) !== "active" && (Y2(e4, o3), o3.parentNode && o3.parentNode.removeChild(o3));
      }
    }(this));
  }
  ...
  return t3.reconstructWithOptions = function(t4, n3) {
    return n3 === undefined && (n3 = true), new e2(v2({}, this.options, {}, t4), this.gs, n3 && this.names || undefined);
  }, t3.allocateGSInstance = function(e3) {
    return this.gs[e3] = (this.gs[e3] || 0) + 1;
  }, t3.getTag = function() {
    return this.tag || (this.tag = (n3 = (t4 = this.options).isServer, r3 = t4.useCSSOMInjection, o3 = t4.target, e3 = n3 ? new U2(o3) : r3 ? new $(o3) : new W2(o3), new T(e3)));
    var e3, t4, n3, r3, o3;
    ...
    if (B2(e3), this.names.has(e3))
      ...
      var n3 = new Set;
      n3.add(t4), this.names.set(e3, n3);
    }
  }, t3.insertRules = function(e3, t4, n3) {
    this.registerName(e3, t4), this.getTag().insertRules(B2(e3), n3);
    ...
    return function(e3) {
      for (var t4 = e3.getTag(), n3 = t4.length, r3 = "", o3 = 0;o3 < n3; o3++) {
        var i3 = M2(o3);
        if (i3 !== undefined) {
          var s3 = e3.names.get(i3), a3 = t4.getGroup(o3);
          if (s3 !== undefined && a3.length !== 0) {
            var c3 = A2 + ".g" + o3 + '[id="' + i3 + '"]', u3 = "";
...
var ie = function() {
  function e2(e3, t3, n3) {
    this.rules = e3, this.staticRulesId = "", this.isStatic = false, this.componentId = t3, this.baseHash = te(oe, t3), this.baseStyle = n3, Z2.registerId(t3);
  }
  return e2.prototype.generateAndInjectStyles = function(e3, t3, n3) {
    var r3 = this.componentId, o3 = [];
    if (this.baseStyle && o3.push(this.baseStyle.generateAndInjectStyles(e3, t3, n3)), this.isStatic && !n3.hash)
      if (this.staticRulesId && t3.hasNameForId(r3, this.staticRulesId))
        o3.push(this.staticRulesId);
      else {
        var i3 = Ne(this.rules, e3, t3, n3).join(""), s3 = ee(te(this.baseHash, i3.length) >>> 0);
        if (!t3.hasNameForId(r3, s3)) {
          var a3 = n3(i3, "." + s3, undefined, r3);
          t3.insertRules(r3, s3, a3);
        }
        o3.push(s3), this.staticRulesId = s3;
      }
    else {
      for (var c3 = this.rules.length, u3 = te(this.baseHash, n3.hash), l3 = "", d3 = 0;d3 < c3; d3++) {
        var h3 = this.rules[d3];
        if (typeof h3 == "string")
          l3 += h3, u3 = te(u3, h3 + d3);
        else if (h3) {
          var p2 = Ne(h3, e3, t3, n3), f2 = Array.isArray(p2) ? p2.join("") : p2;
      ...
      if (l3) {
        ...
        if (!t3.hasNameForId(r3, m)) {
          var y3 = n3(l3, "." + m, undefined, r3);
          t3.insertRules(r3, m, y3);
        }
        o3.push(m);
      }
    }
...
var ve = function() {
  function e2(e3, t3) {
    ...
    this.inject = function(e4, t4) {
      ...
      e4.hasNameForId(n3.id, r3) || e4.insertRules(n3.id, r3, t4(n3.rules, r3, "@keyframes"));
    }, this.toString = function() {
      return j2(12, String(n3.name));
    }, this.name = e3, this.id = "sc-keyframes-" + e3, this.rules = t3;
  }
  return e2.prototype.getName = function(e3) {
    return e3 === undefined && (e3 = pe), this.name + e3.hash;
  }, e2;
}();
var ge = /([A-Z])/;
var Se = /([A-Z])/g;
...
var Pe = function(e2, t3) {
  if (true) {
    var n3 = "The component " + e2 + (t3 ? ' with the id of "' + t3 + '"' : "") + " has been created dynamically.\nYou may see this warning because you've called styled inside another component.\nTo resolve this only create new StyledComponents outside of any render method and function component.";
    try {
      import_react8.useRef(), Ie.has(n3) || (console.warn(n3), Ie.add(n3));
    } catch (e3) {
      Ce.test(e3.message) && Ie.delete(n3);
    }
  }
};
var Oe = function(e2, t3, n3) {
  return n3 === undefined && (n3 = E2), e2.theme !== n3.theme && e2.theme || t3 || n3.theme;
};
var Re = /[!"#$%&'()*+,./:;<=>?@[\\\]^`{|}~-]+/g;
var De = /(^-|-$)/g;
var Te = function(e2) {
...
var ze = import_react8.default.createContext();
var Le = ze.Consumer;
var Fe = {};
var qe = function(e2) {
  return function e(t3, r3, o3) {
    if (o3 === undefined && (o3 = E2), !import_react_is2.isValidElementType(r3))
      return j2(1, String(r3));
    var i3 = function() {
      return t3(r3, o3, Ae.apply(undefined, arguments));
    };
    return i3.withConfig = function(n3) {
      return e(t3, r3, v2({}, o3, {}, n3));
    }, i3.attrs = function(n3) {
      return e(t3, r3, v2({}, o3, { attrs: Array.prototype.concat(o3.attrs, n3).filter(Boolean) }));
    }, i3;
  }(Ye, e2);
};
...
var He = function() {
  function e2(e3, t4) {
    this.rules = e3, this.componentId = t4, this.isStatic = re(e3), Z2.registerId(this.componentId + 1);
  }
  var t3 = e2.prototype;
  return t3.createStyles = function(e3, t4, n3, r3) {
    var o3 = r3(Ne(this.rules, t4, n3, r3).join(""), ""), i3 = this.componentId + e3;
    n3.insertRules(i3, i3, o3);
  }, t3.removeStyles = function(e3, t4) {
    t4.clearRules(this.componentId + e3);
  }, t3.renderStyles = function(e3, t4, n3, r3) {
    e3 > 2 && Z2.registerId(this.componentId + e3), this.removeStyles(e3, n3), this.createStyles(e3, t4, n3, r3);
  }, e2;
}();
var Ue = function() {
  function e2() {
    ...
    this._emitSheetCSS = function() {
      var t4 = e3.instance.toString(), n3 = q2();
      return "<style " + [n3 && 'nonce="' + n3 + '"', A2 + '="true"', 'data-styled-version="5.3.0"'].filter(Boolean).join(" ") + ">" + t4 + "</style>";
    }, this.getStyleTags = function() {
      return e3.sealed ? j2(2) : e3._emitSheetCSS();
    }, this.getStyleElement = function() {
      var t4;
      if (e3.sealed)
        return j2(2);
      var n3 = ((t4 = {})[A2] = "", t4["data-styled-version"] = "5.3.0", t4.dangerouslySetInnerHTML = { __html: e3.instance.toString() }, t4), o3 = q2();
      return o3 && (n3.nonce = o3), [import_react8.default.createElement("style", v2({}, n3, { key: "sc-0-0" }))];
    }, this.seal = function() {
      e3.sealed = true;
  ...
  return t3.collectStyles = function(e3) {
    return this.sealed ? j2(2) : import_react8.default.createElement(ye, { sheet: this.instance }, e3);
...
// src/components/board/BoardStyle.js
...
var Board = ({
  ...
  return jsx_dev_runtime.jsxDEV(Wrapper, {
    ...
    children: Array(width * height).fill().map((v3, i3) => jsx_dev_runtime.jsxDEV(Cell_default, {
      x: i3 % width,
      y: Math.floor(i3 / width)
...
// src/components/board/CellStyle.js
...
var Cell_default2 = import_react10.memo(Cell);
...
var thumbCSS = Ae`
	...
	height: 20px;
`;
var Slider = styled_components_browser_esm_default.input.attrs({
  type: "range"
})`
...
var Wrapper2 = styled_components_browser_esm_default.div`
	...
	text-align: left;
`;
var WidthWrapper = styled_components_browser_esm_default.div`
	margin-bottom: 20px;
`;
var Width = styled_components_browser_esm_default.div`
	margin-bottom: 5px;
`;
var HeightWrapper = styled_components_browser_esm_default.div`
	margin-bottom: 20px;
`;
var Height = styled_components_browser_esm_default.div`
	margin-bottom: 5px;
`;
var MinesWrapper = styled_components_browser_esm_default.div`
	margin-bottom: 30px;
`;
var Mines = styled_components_browser_esm_default.div`
	margin-bottom: 5px;
`;
...
// src/components/status/StatusStyle.js
var Wrapper3 = styled_components_browser_esm_default.div`
	display: flex;
	font-size: 18px;
	margin-top: 20px;
`;
var Mine = styled_components_browser_esm_default.div`
	flex: 1;
	text-align: left;
`;
var ButtonWrapper = styled_components_browser_esm_default.div`
	...
	text-align: center;
`;
var RestartButton = styled_components_browser_esm_default.span`
	cursor: pointer;
`;
...
var Status = ({
  ...
  return jsx_dev_runtime4.jsxDEV(Wrapper3, {
    children: [
      jsx_dev_runtime4.jsxDEV(Mine, {
        children: [
          "\uD83D\uDCA3 ",
          leftMineCount,
          " / ",
      ...
      jsx_dev_runtime4.jsxDEV(ButtonWrapper, {
        children: [
          jsx_dev_runtime4.jsxDEV(RestartButton, {
            title: "Restart",
            onClick: onClickRestart,
            children: resultEmoji
          }, undefined, false, undefined, this),
          enableSettings && jsx_dev_runtime4.jsxDEV(SettingsButton, {
            title: "Settings",
...
var BoardContainer = () => {
  ...
  const onRightClickBoard = import_react13.useCallback((e2) => {
    e2.preventDefault();
  }, []);
...
var CellContainer = ({
  ...
  const cellCode = useSelector((rootState) => rootState.control.boardData[y3][x3]);
  const getCellText = import_react14.useCallback((code) => {
    switch (code) {
      case CODES.OPENED:
      case CODES.NOTHING:
        return "";
  ...
  const onClickCell = import_react14.useCallback(() => {
    if (gameState === GAME.READY || gameState === GAME.RUN) {
      dispatch(openCell(x3, y3));
    }
  }, [gameState]);
  const onRightClickCell = import_react14.useCallback((e2) => {
    e2.preventDefault();
    if (gameState === GAME.READY || gameState === GAME.RUN) {
      dispatch(rotateCellState(x3, y3));
    }
  }, [gameState]);
  return jsx_dev_runtime6.jsxDEV(Cell_default2, {
    cellCode,
...
var Cell_default = import_react14.memo(CellContainer);
...
var SettingsContainer = () => {
  const dispatch = useDispatch();
  const enableSettings = useSelector((rootState) => rootState.control.enableSettings);
  const [width, setWidth] = import_react15.useState(MIN_WIDTH);
  const [height, setHeight] = import_react15.useState(MIN_HEIGHT);
  const [mineCount, setMineCount] = import_react15.useState(MIN_MINES);
  ...
  const onChangeWidth = import_react15.useCallback((e2) => {
    setWidth(parseInt(e2.target.value));
  }, []);
  const onChangeHeight = import_react15.useCallback((e2) => {
    setHeight(parseInt(e2.target.value));
  }, []);
  const onChangeMines = import_react15.useCallback((e2) => {
    setMineCount(parseInt(e2.target.value));
  }, []);
  const onClickSet = import_react15.useCallback(() => {
...
var StatusContainer = () => {
  ...
  const getResultEmoji = import_react16.useCallback((gameState2) => {
    switch (gameState2) {
      case GAME.WIN:
        return "\uD83D\uDE0E";
      case GAME.LOSE:
  ...
  const onClickRestart = import_react16.useCallback(() => {
    dispatch(restartGame());
  }, []);
  const onClickSettings = import_react16.useCallback(() => {
    dispatch(showSettings());
  }, []);
  return jsx_dev_runtime8.jsxDEV(jsx_dev_runtime8.Fragment, {
    children: !enableSettings && jsx_dev_runtime8.jsxDEV(Status_default, {
...
var Status_default2 = StatusContainer;
// src/AppStyle.js
var Wrapper4 = styled_components_browser_esm_default.div`
	...
	padding: 30px;
`;
var Title = styled_components_browser_esm_default.h1`
	text-align: center;
`;
...
import_react_dom2.default.render(jsx_dev_runtime10.jsxDEV(Provider_default, {
  store: store_default,
  children: jsx_dev_runtime10.jsxDEV(App_default, {}, undefined, false, undefined, this)
}, undefined, false, undefined, this), document.getElementById("react-root"));
